...
1. Data manipulation on **steroids**. It works on so many file formats, with dozens of utility functions to get output of data. You can convert JSON to Markdown tables!
1. Each function does one thing and does it well. Wait, isn't this Unix's philosophy? Yes, Nushell feels like what we should have had from the beginning. It feels a lot "more UNIX" than bash or zsh, despite it technically being "not POSIX-compliant"
...
1. The scripting language is just expressive, beautiful and so much easier to read and write than bash is. I'll say that it's the best scripting language out of all of them. It is like the Rust of scripting languages.
